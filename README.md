# DataPulse - Система прогнозирования продаж на основе машинного обучения
...
**data_processor.py** - модуль предварительной обработки данных, выполняющий базовые операции очистки, агрегации и создания простых признаков. Служит облегченной альтернативой data_manager для простых сценариев.
